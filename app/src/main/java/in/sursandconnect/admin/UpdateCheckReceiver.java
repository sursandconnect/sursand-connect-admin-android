...
public class UpdateCheckReceiver extends BroadcastReceiver {
    ...
    private void check(Context context) throws Exception {
        ...
        JSONObject latest = latestOf(data.optJSONArray("events"), data.optJSONArray("announcements"));
    ...
    private JSONObject latestOf(JSONArray a, JSONArray b) {
        JSONObject best = null; long bestTime = Long.MIN_VALUE;
        for (JSONArray arr : new JSONArray[]{a,b}) {
